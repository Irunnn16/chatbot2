...
const ArticleUploadMediaSheet: FC<Props> = ({ article, children }) => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to article</SheetDescription>
        </SheetHeader>
...
export default ArticleUploadMediaSheet;
